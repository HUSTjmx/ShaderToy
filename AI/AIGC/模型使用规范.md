...
> ==prompt==：1girl, solo,mix4,(5 stars hotel),hotel, (realistic:1.1), (photorealistic:1.1), (masterpiece:1.1), (best quality:1.1),  highres, ultra detailed, cowboy shot, upper body, looking at viewer, smile,(fullbody), black_little_dress, lace trim,dress,natural lighting, pureerosface_v1,
> \<lora:little_black_dress:0.85>, \<lora:A_BaseFace_1_cuteGirlMix4_v10:0.5>  \<lora:A_BaseFace_5_asiaMix_v10:0.5>
>
> ==Negative prompt==: ng_deepnegative_v1_75t,bad-picture-chill-75v
>
> ENSD: 31337, Size: 512x768, Seed: 1694988972, Model: **chilloutmix_NiPrunedFp32Fix**, Steps: 30, Sampler: DPM++ 2S a Karras, CFG scale: 8, Clip skip: 2, Model hash: fc2511737a, Hires upscale: 2, Hires upscaler: ESRGAN_4x, Denoising strength: 0.4
>
> <img src="模型使用规范.assets/04556-1694988972-1girl, solo,mix4,(5 stars hotel),hotel, (realistic_1.1), (photorealistic_1.1), (masterpiece_1.1), (best quality_1.1),  highres,.jpeg" alt="04556-1694988972-1girl, solo,mix4,(5 stars hotel),hotel, (realistic_1.1), (photorealistic_1.1), (masterpiece_1.1), (best quality_1.1),  highres,.png" style="zoom:50%;" />



## FairyTaleV20_SD1.5.safetensors [LoRA] {==剪纸、水晶花==}

- 两种风格: `craft`和`art paiting`。关键词: ***paper-cut [craft/art painting]***。

- 有/无相框，关键词:  photo-frame/no-frame。

- 有/无mask，关键词:  [shape] mask/no-mask

[下载地址](https://civitai.com/models/52034/midjourney-fairy-tale-lora)

![image-20230510173043609](模型使用规范.assets/image-20230510173043609.png)

<img src="模型使用规范.assets/image-20230510173248633.png" alt="image-20230510173248633" style="zoom: 80%;" />

> paper-cut craft, no-frame, no-mask, yin-yang symbol outline,  left side fill green blue flowers and sun, right side fill red yellow red feathers and full moon, colorful, gradient  blue red wall, \<lora:FairyTaleV20_SD1.5:0.5>
>
> Size: 512x512, Seed: 225417765, Model: **lyrielV15_3D_SD1.5**, Steps: 20, Sampler: DPM++ 2M alt Karras, CFG scale: 7, Model hash: 4d91c4c217
>
> <img src="模型使用规范.assets/00166-225417765.jpeg" alt="00166-225417765.png" style="zoom:50%;" />





## TerranAI.safetensors [LoRA] {==星际争霸机器风==}

[下载地址](https://civitai.com/models/61918/terranai)

![image-20230510173658802](模型使用规范.assets/image-20230510173658802.png)



> ==prompt==：(best quality, masterpiece, realistic, detailed), 8k CG, perfect artwork,coffee machine,TerranAI, \<lora:TerranAI:1>
>
> ==Negative prompt==: (worst quality, low quality:1.3),
>
> ENSD: 31337, Size: 512x512, Seed: 1961392085, Model: **revAnimated_v122**, Steps: 25, Sampler: DPM++ 2M Karras, CFG scale: 10, Clip skip: 2, Model hash: f8bb2922e1, Hires steps: 10, Hires upscale: 2, Hires upscaler: R-ESRGAN 4x+ Anime6B, Denoising strength: 0.5
>
> <img src="https://image.civitai.com/xG1nkqKTMzGDvpLrqFT7WA/915760f2-4987-4ba9-8a63-47509422e7c6/width=450/00260-1961392085.jpeg" alt="00260-1961392085.png" style="zoom:50%;" />





## zhangbozhi.safetensors [LoRA] {==张柏芝==}

[下载地址](https://civitai.com/models/61681/cecilia-cheung-zhang-bozhi)

![image-20230510173930373](模型使用规范.assets/image-20230510173930373.png)

> ==prompt==：modelshoot style,(best quality, masterpiece:1.1), (realistic:1.4), intricate elegant, (highly detailed),sharp focus, dramatic,photorealistic, detailed eyes, looking at viewer,A beautiful Miss,(High Detail ), smile,(hanfu:1.1),((studio light and shadow,warm light ,depth of field)),Wide angle view
>
> ==Negative prompt==: (((canvas frame))), cartoon, 3d, ((disfigured)), ((bad art)), ((deformed)),((extra limbs)),((close up)),((b&w)), wierd colors, blurry, (((duplicate),)), ((morbid)), ((mutilated)), [out of frame], bad-hands-5, bad-image-v2-39000, bad_prompt_version2, bad_quality, badhandv4, easynegative
>
> ENSD: 31337, Size: 512x768, Seed: 2449668358, Model: **chilled_remix_v1vae**, Steps: 50, Sampler: DPM++ 2M Karras, CFG scale: 15, Clip skip: 2, Model hash: 70e66e96d7, Mimic scale: 7, Hires upscale: 1.5, AddNet Enabled: True, AddNet Model 1: zhangbozhi(6ce9d55d0997), Hires upscaler: 4x-UltraSharp, AddNet Module 1: LoRA, AddNet Weight A 1: 0.9, AddNet Weight B 1: 0.9, Denoising strength: 0.3, Threshold percentile: 100, Dynamic thresholding enabled: True
>
> <img src="模型使用规范.assets/00122-2449668358.jpeg" alt="00122-2449668358.png" style="zoom:50%;" />



## angie_lora-05.safetensors [LoRA] {==安琪美女==}

[下载地址](https://civitai.com/models/61847/angie00mycoser)

> 1girl,(wearing a roomwear),(RAW photo, best quality), (realistic, photo-realistic:1.4), masterpiece, an extremely delicate and beautiful, extremely detailed, 2k wallpaper, Amazing, finely detail, extremely detailed CG unity 8k wallpaper, ultra-detailed, highres, soft light, beautiful detailed girl, extremely detailed eyes and face, beautiful detailed nose, beautiful detailed eyes,cinematic lighting,city lights at night,in tokyo downtown,perfect anatomy,soft light
>
> Steps: 20, Sampler: DPM++ SDE Karras, CFG scale: 6
>
> <img src="模型使用规范.assets/322378999023755643.png" alt="322378999023755643.png" style="zoom:50%;" />



### FilmG2.safetensors [LoRA] {==胶片质感！==}

这是一个用于生成胶片风格AI写真照片的LoRA。与[MoonMIX](https://civitai.com/models/43977/moonmix)或[Chilloumix](https://civitai.com/models/6424/chilloutmix)搭配使用，可以生成逼真的胶片风格照片。作者常用的CFG范围是5\~7，Lora权重通常在0.5~0.7。

[下载地址](https://civitai.com/models/33208?modelVersionId=55910)

![image-20230510174422828](模型使用规范.assets/image-20230510174422828.png)

> ==prompt==：\<lora:FilmG2:1>, filmg, fashion photography portrait of 1girl, offshoulder, fluffy short hair, soft light, rim light, beautiful shadow, low key, (photorealistic, raw photo:1.2), (natural skin texture, realistic eye and face details), hyperrealism, ultra high res, 4K, Best quality, masterpiece, necklace, (cleavage:0.8), in the dark
>
> ==Negative prompt==: cartoon, anime, sketches, (worst quality:1.5), (low quality:1,.5), lowres, ((monochrome)), (deformed, distorted, disfigured:1.3), poorly drawn,large hands, bad anatomy, wrong anatomy, extra limb, missing limb, floating limbs, (mutated hands and fingers:1.4), disconnected limbs, mutation, mutated, ugly, disgusting, blurry, amputation, (EasyNegative:0.6)
>
> ENSD: 31337, Size: 512x768, Seed: 2177147223, Model: MoonMIXreality2, Steps: 30, Sampler: DPM++ 2M Karras, CFG scale: 7, Model hash: b4a6146af2, Hires steps: 24, Hires upscale: 2, Hires upscaler: Latent (bicubic antialiased), Denoising strength: 0.55
>
> <img src="模型使用规范.assets/21260-2177147223-, filmg, fashion photography portrait of 1girl, offshoulder, fluffy short hair, soft light, rim light, beautiful shadow, low key.jpeg" alt="21260-2177147223-, filmg, fashion photography portrait of 1girl, offshoulder, fluffy short hair, soft light, rim light, beautiful shadow, low key.png" style="zoom:50%;" />





## nwsjmajic-05.safetensors [LoRA] {==美女==}

[下载地址](https://civitai.com/models/53601/nwsjrealistic)

> 作者用自己训的

> ==prompt==：masterpiece, best quality,realistic,realskin,1girl,outdoor,low_key, \<lora:FilmG2:0.8>
>
...
>
> ENSD: 31337, Size: 512x768, Seed: 1836578086, Model: real_majicmixRealistic_v4, Steps: 20, Sampler: DPM++ 2M Karras, CFG scale: 7, Clip skip: 2, Model hash: d819c8be6b, ADetailer conf: 30, ADetailer model: face_yolov8n.pt, fashionGirl_v53: 0.2>, ADetailer version: 23.5.6.post0, ADetailer x offset: 0, ADetailer y offset: 0, ControlNet 0 Model: control_v11p_sd15_inpaint [ebff9138], ADetailer CFG scale: 7.0, ADetailer mask blur: 8, ControlNet 0 Weight: 1.0, ControlNet 0 Enabled: True, ADetailer dilate/erode: 32, ADetailer inpaint full: True, ADetailer inpaint width: 512, ADetailer inpaint height: 768, ControlNet 0 Ending Step: 1.0, ControlNet 0 Resize Mode: ResizeMode.INNER_FIT, ADetailer inpaint padding: 0, ADetailer negative prompt: easynegative, ControlNet 0 Control Mode: ControlMode.BALANCED, ControlNet 0 Preprocessor: inpaint_global_harmonious, ADetailer ControlNet model: control_v11p_sd15_inpaint [ebff9138], ControlNet 0 Pixel Perfect: True, ControlNet 0 Starting Step: 0.0, ADetailer ControlNet weight: 1.0, ADetailer denoising strength: 0.3, ADetailer use inpaint width/height: True, ControlNet 0 Preprocessor Parameters: "(512, 64, 64)"
>
> <img src="模型使用规范.assets/04945-1836578086-masterpiece, best quality,realistic,realskin,1girl,outdoor,low_key,.jpeg" alt="04945-1836578086-masterpiece, best quality,realistic,realskin,1girl,outdoor,low_key,.png" style="zoom:50%;" />





## pixel_f2.safetensors [LoRA] {==像素风==}

[下载地址](https://civitai.com/models/44960?modelVersionId=49584)

![image-20230510174935790](模型使用规范.assets/image-20230510174935790.png)



>  ==prompt==：(masterpiece, top quality, best quality), pixel,pixel art,1girl,tifa,
> \<lora:pixel_4:0.5> \<lora:tifaMeenow_tifaV2:0.8>
>
> ==Negative prompt==: (worst quality, low quality:2),
>
> ENSD: 31337, Size: 512x768, Seed: 4004235146, Model: ghostmix_v11, Steps: 30, Sampler: DPM++ SDE Karras, CFG scale: 7.5, Clip skip: 2, Model hash: 9c321174ae
>
> <img src="模型使用规范.assets/00089-4004235146.jpeg" alt="00089-4004235146.png" style="zoom:50%;" />



## GirlfriendMix2.safetensors [LoRA] {==美女==}

[下载地址](https://civitai.com/models/45462/girlfriendmixv1)

![image-20230510175155198](模型使用规范.assets/image-20230510175155198.png)

> ==prompt==：\<lora:GirlfriendMix2:1>,1girl, Tokyo street,night, cityscape,city lights, upper body,close-up, 8k, RAW photo, best quality, masterpiece,realistic, photo-realistic,red rose,
>
...
>
> ENSD: 31337, Size: 512x768, Seed: 3984426260, Model: [XXMix_9](https://civitai.com/models/47274/xxmix9), Steps: 20, Sampler: DPM++ 2M alt Karras, CFG scale: 6.5, Clip skip: 2, Model hash: 0dcf919f41, ControlNet-0 Model: control_v11p_sd15_openpose [cab727d4], ControlNet-1 Model: control_v11p_sd15_softedge [a8575a2a], ControlNet-0 Module: openpose_full, ControlNet-0 Weight: 1, ControlNet-1 Module: softedge_hed, ControlNet-1 Weight: 0.6, ControlNet-0 Enabled: True, ControlNet-1 Enabled: True, ControlNet-0 Guidance End: 1, ControlNet-1 Guidance End: 1, ControlNet-0 Guidance Start: 0, ControlNet-1 Guidance Start: 0
>
> <img src="模型使用规范.assets/05297-3984426260-_1girl, Tokyo street,night, cityscape,city lights, upper body,close-up, 8k, RAW photo, best.jpeg" alt="05297-3984426260-_1girl,%20Tokyo%20street,night,%20cityscape,city%20lights,%20upper%20body,close-up,%208k,%20RAW%20photo,%20best.png" style="zoom:50%;" />





## XXMix9_v20LoRa.safetensors [LoRA] {==高质量美女==}

[下载地址](https://civitai.com/models/55338/xxmix9v20lora)

![image-20230510175810953](模型使用规范.assets/image-20230510175810953.png)

> ==prompt==：Hyperrealist portrait of female by david hockney and alphonse mucha,fantasy art, photo realistic, dynamic lighting, artstation, poster, volumetric lighting, very detailed faces, 4 k, award winning,, 1girl, in the dark, deep shadow, low key,cowboy shot,(official clothing:1.4) ,long hair,white hair, \<lora:XXMix9_v20LoRa:0.8>
>
...
>
> ENSD: 31337, Size: 512x768, Seed: 1911145195, Model: **XXmix9_v10**, Steps: 20, Sampler: DPM++ 2M alt Karras, CFG scale: 6.5, Clip skip: 2, Model hash: 0dcf919f41
>
> <img src="模型使用规范.assets/13059-1911145195-Hyperrealist portrait of female by david hockney and alphonse mucha,fantasy art, photo realistic, dynamic light.jpeg" alt="13059-1911145195-大卫·霍克尼和阿尔方斯·慕夏的超现实主义女性肖像，幻想艺术，逼真照片，动态光.png" style="zoom:50%;" />



## mix4.safetensors [LoRA] {==美女==}

[下载地址](https://civitai.com/models/14171/cutegirlmix4)

![image-20230510180743226](模型使用规范.assets/image-20230510180743226.png)



> ==prompt==：\<lora:mix4:0.7>, mix4, \<lora:20d:0.5>, 20d, solo, long_hair, shirt, dress, high_heels,full_body, look_at_viewer, (8k, RAW photo, best quality, masterpiece:1.2), (realistic, photo-realistic:1.37), professional lighting, photon mapping, radiosity, physically-based rendering,
>
...
>
> <img src="模型使用规范.assets/244295.jpeg" alt="img" style="zoom:50%;" />





## GirlfriendMix_v1_v20.safetensors [LoRA] {美女}

[下载地址](https://civitai.com/models/49713/dreamgirl)

![image-20230510181009078](模型使用规范.assets/image-20230510181009078.png)

![image-20230510181027742](模型使用规范.assets/image-20230510181027742.png)

> ==prompt==：1girl, solo,(best quality),(masterpiece:1.1),(school uniform:1.4),green eyes, dress, looking_at_viewer, neck_ribbon, cute, clear facial skin, \<lora:GirlfriendMix_v1_v20:1>
>
> ==Negative prompt==: (worst quality:2), (low quality:2), (normal quality:2), lowres, bad anatomy, bad hands, normal quality, ((monochrome)), ((grayscale))
>
> ENSD: 31337, Size: 512x768, Seed: 2525159717, Model: XXMix_9, Steps: 20, Sampler: DPM++ 2M alt Karras, CFG scale: 7, Clip skip: 2, Model hash: 0dcf919f41, Hires steps: 10, Hires upscale: 2, Hires upscaler: 4x-UltraSharp, Denoising strength: 0.35
>
> <img src="模型使用规范.assets/06856-2525159717-1girl, solo,(best quality),(masterpiece_1.1),(school uniform_1.4),green eyes, dress, looking_at_viewer, neck_ri.jpeg" alt="06856-2525159717-1girl, solo,(best quality),(masterpiece_1.1),(school uniform_1.4),green eyes, dress, looking_at_viewer, neck_ri.png" style="zoom:50%;" />
>
> 
...
## 祥龙20230414版.safetensors [LoRA] {==中国龙==}

[下载地址](https://civitai.com/models/21530?modelVersionId=45226)

![image-20230510181431299](模型使用规范.assets/image-20230510181431299.png)

![image-20230510181438730](模型使用规范.assets/image-20230510181438730.png)

>  ==prompt==：{high quality}, simple background, chinese dragon, serpentine long body, scaly skin, golden theme, claws, horns, 
>  \<lora:0.8>
>
>  ==Negative prompt==: low quality, extra head, extra tail, extra body, bad anatomy
>
>  Seed: -1, Steps: 30, Sampler: LMS Karras, CFG scale: 7
>
>  <img src="模型使用规范.assets/00067.jpeg" alt="00067.jpg" style="zoom:50%;" />



## BlueSD.safetensors [LoRA] {==Q版Emoji==}

[下载地址](https://civitai.com/models/43256/blue-archive-emoji-style)

![image-20230510181627240](模型使用规范.assets/image-20230510181627240.png)

> ==prompt==：arona, 1girl, white hairband, bow hairband, halo, short hair, single braid, school uniform, blue shirt, white sailor collar, long sleeves, white bowtie, white choker, white background, \<lora:aronaBlueArchive_v1:0.6>, chibi, \<lora:BlueSD:0.7>
>
> ==Negative prompt==: (worst quality, low quality:1.4), extra fingers, fewer fingers, watermark, text
>
> Size: 512x512, Seed: 494371111, Model: anything-v4.5, Steps: 20, Sampler: DPM++ 2M Karras, CFG scale: 7, Clip skip: 2, Model hash: 1d1e459f9f, Hires upscale: 2, Hires upscaler: R-ESRGAN 4x+ Anime6B, Denoising strength: 0.5
>
> <img src="模型使用规范.assets/00031-494371111.png" alt="00031-494371111.png" style="zoom:50%;" />





## grav-Enako.safetensors [LoRA] {==美女==}

[下载地址](https://civitai.com/models/39509/ai-grav-enako)

> ==prompt==：a woman posing on the street corner, best quality, 1girl, huge breasts, day, bright, blur background, outdoor, (street:0.8), (medium hair, looking at viewer, high-neck sweater:1.6), (looking at the camera), ((smile, gorgeous, medium-length hair, parted bangs:1.3)), (looking at the camera), photorealistic, (bokeh), (portait:0.6), dynamic pose:1.2, upper body, pureerosface_v1:1,  \<lora:grav-Enako:0.55>
>
> ==Negative prompt==: cleavage, (fingers), maid headress, maid, backlight, (backlighting), (((window))), canvas frame, cartoon, earrings, ((disfigured)), ((bad art)), ((deformed)),((extra limbs)),((close up)),((b&w)), weird colors, blurry, (((duplicate))), ((morbid)), ((mutilated)), [out of frame], extra fingers, mutated hands, ((poorly drawn hands)), ((poorly drawn face)), (((mutation))), (((deformed))), ((ugly)), blurry, ((bad anatomy)), (((bad proportions))), ((extra limbs)), cloned face, (((disfigured))), out of frame, ugly, extra limbs, (bad anatomy), gross proportions, (malformed limbs), ((missing arms)), ((missing legs)), (((extra arms))), (((extra legs))), mutated hands, (fused fingers), (too many fingers), (((long neck))), paintings, sketches, (worst quality:2), (low quality:2), (normal quality:2), lowres, normal quality, ((monochrome)), ((grayscale)), ((skin spots)), acnes, skin blemishes, ((age spot)), bad anatomy, bad_prompt_version2, easynegative, out of frame, mutation, mutated, extra limbs, extra legs, extra arms, disfigured, deformed, cross-eye, body out of frame, blurry, bad art, bad anatomy, tilting picture, tilting view, body rotation, ((looking sideway)), ((looking behind the shoulder)), ((cropped head))
>
> Size: 540x672, Seed: 2729904395, Model: henmixReal_v22, Steps: 35, Sampler: DPM++ SDE Karras, CFG scale: 4, Model hash: b41db754cb, Hires steps: 10, Hires upscale: 2, Hires upscaler: R-ESRGAN 4x+ Anime6B, Denoising strength: 0.4
>
> <img src="模型使用规范.assets/00140-1761710330.jpeg" alt="00140-1761710330.png" style="zoom:50%;" />



## Liyitong_v1.safetensors [LoRA] {==李一桐==}

[下载地址](https://civitai.com/models/44324/li-yitong-cn-actress)

> ==prompt==：(sleeveless chinese clothes:1.5), floral print,  depth of field, night cityscape, (1girl:1.6),   long hair, ulzzang-6500v1.1, (original: 1.2), (realistic: 1.3) , beautiful girl with beautiful details, extremely detailed eyes and face, eyes with beautiful details, absurd, incredibly absurd, huge file size, ultra detail, high resolution, ultra detailed, best quality, masterpiece, illustration, ultra detailed and beautiful, ultra detailed, CG, unity, 8k wallpaper, amazing, fine Detail, masterpiece, top quality, official art, extremely detailed CG unity 8k wallpaper, cinematic lighting, (perfect shiny skin:0.6), slim and smooth lines, (floating), (small breasts:1),  earrings ,   \<lora:Liyitong_v1:0.8>
>
> ==Negative prompt==: paintings, sketches, (worst quality:2), (low quality:2), (normal quality:2), dot, mole, lowers, normal quality, monochrome, grayscale, lowers, text, error, cropped, worst quality, low quality, jpeg artifacts, ugly, duplicate, morbid, mutilated, out of frame, extra fingers, mutated hands, poorly drawn hands, poorly drawn face, mutation, deformed, blurry, dehydrated, bad anatomy, bad proportions, extra limbs, cloned face, disfigured, gross proportions, malformed limbs, missing arms, missing legs, extra arms, extra legs, fused fingers, too many fingers, long neck, username, watermark, signature,
>
> ENSD: 31337, Size: 640x960, Seed: 4248654398, Model: chilloutmix_NiPrunedFp32Fix, Steps: 28, Sampler: Euler a, CFG scale: 7, Model hash: fc2511737a
...
## NewChineseStyleSuit_v1.safetensors [LoRA]  {==新汉服==}

新中式服饰系列LoRa，以鲜花为形，百褶为型，重新定义新中式裙式。**推荐权重：0.6~1**（裙摆褶皱会逐步变复杂）。在二次元、2.5D和写实模型下表现都非常好。[下载地址](https://civitai.com/models/60909/new-chinese-style-suitlora)

![image-20230523123917701](模型使用规范.assets/image-20230523123917701-1684816759472-1.png)

>  ==prompt==：masterpiece, best quality,newchinesestylesuit,,1girl , looking at viewer, full body, simple background, Cement Gray dress,
>
> ==Negative prompt==: EasyNegative,(worst quality, low quality:1.4), (((deformed))), blurry, bad anatomy, disfigured, poorly drawn face, mutation, mutated, (extra_limb), (ugly), (poorly drawn hands), fused fingers, canvas frame, cartoon, 3d, ((disfigured)), ((bad art)), ((deformed)),((extra limbs)),((close up)),((b&w)), wierd colors, blurry, (((duplicate))), ((morbid)), ((mutilated)), [out of frame], extra fingers, mutated hands, ((poorly drawn hands)), ((poorly drawn face)), (((mutation))), (((deformed))), ((ugly)), blurry, ((bad anatomy)), (((bad proportions))), ((extra limbs)), cloned face, (((disfigured))), out of frame, ugly, extra limbs, (bad anatomy), gross proportions, (malformed limbs), ((missing arms)), ((missing legs)), (((extra arms))), (((extra legs))), mutated hands, (fused fingers), (too many fingers), (((long neck))), Photoshop, video game, ugly, tiling, poorly drawn hands, poorly drawn feet, poorly drawn face, out of frame, mutation, mutated, extra limbs, extra legs, extra arms, disfigured, deformed, cross-eye, body out of frame, blurry, bad art, bad anatomy, 3d render, mutated eyes, cleavage, sfw, lowres, bad anatomy, bad hands, text, error, missing fingers, extra digit, fewer digits, cropped, worst quality, low quality, normal quality, jpeg artifacts, signature, watermark, username, blurry, crown, hat, multiple hands, bad hands, bad anatomy, ugly, gallant, blurry, floating, multiple body, duplicate, extra fingers, extra limbs, mutation, deformed, disfigured, morbid, long body, asymmetric, poorly drawn face, cloned face, cloned head, asymmetric ears, asymmetric ear rings, floating hair, (long neck), cross eyed, blinking, winking, makeup, lipstick, eye liner, eyeliner, kitsch, bad art, bad taste, unnatural, staged, missing limb, missing arm, missing leg, floating limb, disconnected limb, extra limb, too many fingers, extra fingers, malformed limbs, malformed hands, poorly drawn hands, (mutated hands), (mutated fingers), mutilated hands, extra tail, missing tail,No tents,,chibi,loli,
>
> ENSD: 31337, Size: 512x768, Seed: 3125544453, Model: 3Guofeng3_v33, Steps: 32, Sampler: DPM++ 2M Karras, CFG scale: 7, Clip skip: 2, Model hash: 4078eb4174, Hires steps: 20, Hires upscale: 2, AddNet Enabled: True, AddNet Model 1: NewChineseStyleSuit_v01(78340d47f7ce), Hires upscaler: R-ESRGAN 4x+, AddNet Module 1: LoRA, Wildcard prompt: "masterpiece, best quality,newchinesestylesuit,,1girl , looking at viewer, full body, simple background, __color__ dress, ", AddNet Weight A 1: 0.95, AddNet Weight B 1: 0.95, Denoising strength: 0.6
>
> <img src="模型使用规范.assets/30147-3125544453-masterpiece, best quality,newchinesestylesuit,,1girl , looking at viewer, full body, simple background, Cement Gray dress,.jpeg" alt="30147-3125544453-masterpiece, best quality,newchinesestylesuit,,1girl , looking at viewer, full body, simple background, Cement Gray dress,.png" style="zoom:50%;" />
...
## PersonaCutIn-06.safetensors [LoRA] {==超帅角色切入==}

权重可以从 ：0.9~1.0。作者推荐`1`， 适用于几乎所有角色、真实感模型。建议使用**768 X 512**。[下载地址](https://civitai.com/models/67625/persona-cut-in-or-concept-lora)

![image-20230523124214737](模型使用规范.assets/image-20230523124214737.png)

> ==prompt==：Highly detailed, High Quality, Masterpiece, beautiful, Persona Cut In,  \<lora:PersonaCutIn-06:1>, 1boy, solo, Jetstream Sam, facial hair, male focus, beard, cyborg, \<lora:Char_MGR_JetstreamSam:0.9>
>
> ==Negative prompt:==  (badhandv4), (badv4:0.9), (worst quality, low quality:1.4), nipples,
>
> Size: 768x512, Seed: 3337303453, Model: ==revAnimated_v122==, Steps: 20, Sampler: DPM++ SDE Karras, CFG scale: 7, Clip skip: 2, Model hash: 4199bcdd14, Hires upscale: 2, Hires upscaler: 4x-AnimeSharp, Denoising strength: 0.4
>
> <img src="模型使用规范.assets/01125-3337303453.jpeg" alt="01125-3337303453.png" style="zoom: 80%;" />





## soulcard.safetensors [LoRA] {==超帅塔罗牌卡面==}

画简单塔罗牌卡面的lora模型，模型只有在**512x896的分辨率**下才能生成正常的花纹，也可以搭配**人物lora**使用，生成人物在卡牌上的效果，搭配其它lora使用时不需要严格**512x896**。[下载地址](https://civitai.com/models/67927/soulcard)

![image-20230523124446032](模型使用规范.assets/image-20230523124446032.png)

> ==prompt==：soul card, line, fox , no people,  \<lora:soulcard-000002:1>
>
> ENSD: 31337, Size: 512x896, Seed: 830244037, Model: CamelliaMix_2.5D_V2, Steps: 40, Sampler: Euler a, CFG scale: 7, Clip skip: 2, Model hash: ed4f26c284
>
> <img src="模型使用规范.assets/00094-830244037.jpeg" alt="00094-830244037.png" style="zoom: 50%;" />





## elizabeth_olsen_v2.safetensors [LoRA] {==红女巫==}

**Example Prompt**:  best quality, Elizabeth Olsen, 1girl, solo, long hair, breasts, looking at viewer, smile, brown hair, black hair, cleavage, upper body, lips, realistic \<lora:elizabeth_olsen:0.6>

[下载地址](https://civitai.com/models/68607/elizabetholsen)

![image-20230523124746573](模型使用规范.assets/image-20230523124746573.png)

>  ==prompt==：best quality, elizabeth_olsen, 1girl, solo, short hair, looking at viewer, smile, green eyes, lips, portrait, realistic, simple background,
>
> ==Negative prompt==: EasyNegative,  ng_deepnegative_v1_75t,  bad-image-v2-39000,  bad-hands-5
>
> Size: 512x704, Seed: 29248753, Model: ==chilloutmix_NiPrunedFp32Fix==, Steps: 20, Version: v1.2.0, Sampler: DPM++ SDE Karras, CFG scale: 7, Model hash: fc2511737a, AddNet Enabled: True, AddNet Model 1: elizabeth_olsen_v2(00d76aa0a921), AddNet Module 1: LoRA, AddNet Weight A 1: 0.6, AddNet Weight B 1: 0.6
>
> <img src="模型使用规范.assets/00215-29248753.jpeg" alt="00215-29248753.png" style="zoom:50%;" />
...
## zyd232_ChineseGirl_v4_2.safetensors [LoRA] {==中国美女==}

推荐权重：**0.7**。建议分辨率：**768*768**。[下载地址](https://civitai.com/models/13021/zyd232s-chinese-girl-lora)

![image-20230523125106771](模型使用规范.assets/image-20230523125106771.png)

>  ==prompt==：\<lora:zyd232_ChineseGirl_v4_2:0.7> zydG, 1girl, detailed skin, looking at viewer, brown eyes, (short hair with bangs:1.2), (large breasts:1.0), (large areolae:0.8), smile, (face focus:1.4), close shot, (photorealistic:1.4), (best quality:1.0), (ultra highres:1.0), 8k, RAW photo, (masterpiece:0.2), (sportswear:1.5), portrait, (pureerosface_v1:0.5)
>
> ==Negative prompt==:  (mole, mole on face, mole under eye, mole under mouth, freckles, body freckles:1.2), tattoo, (wrinkled skin, wrinkle:1.2), watermark, painting, cartoons, sketch, (worst quality:2), (low quality:2), (normal quality:2), lowers, bad anatomy, bad hands, (bad-hands-5:0.8), (nsfw, nude, cleavage, uncensored, penis, pussy, nipples, covered nipples, areolae, nipple slip, areola slip:1.5) (photorealistic:1.4), (best quality:1.0), (ultra highres:1.0), 8k, RAW photo, (masterpiece:0.2), (sportswear:1.5), portrait, (pureerosface_v1:0.5)
>
> ENSD: 31337, Size: 512x640, Seed: 372227578, Model: **NSFW_shampooMix_v30**, Steps: 32, Version: v1.2.1, Sampler: DPM++ 2M Karras, CFG scale: 7, Clip skip: 2, Model hash: 91dc480640, Hires steps: 20, Hires upscale: 2.5, Hires upscaler: 4x-UltraSharp, Denoising strength: 0.3
>
> <img src="模型使用规范.assets/image-20230523125240546.png" alt="image-20230523125240546" style="zoom:50%;" />
>
> 



## _manguri.safetensors [LoRA] {==涩涩姿势==}

权重应该在0.7左右，复现率高！[下载地址](https://civitai.com/models/72820/manguri-gaeshi-nsfw-folded-pose-nsfw-lora)

![image-20230523132344073](模型使用规范.assets/image-20230523132344073.png)

> ==prompt==：\<lora:manguri:1>, manguri folded holding legs, Shoulders and back of head on the bed  legs_up knees_on_chest Butt up, spread legs, - yellow sweater, heart cutout sky blue long skirt  slouch socks platform boots, +++ extremely quality, high detailed, anime coloring illustration game cg contrapposto \<lora:_flat2:0.4:OUTDD> ++ Faint lips,UC:realistic cute anime face cinematic angle Girl at the front single focus dynamic pose
>
> ==Negative prompt==: badhandv4 EasyNegative ng_deepnegative_v1_75t NSFW, 3d:1.4
>
> ENSD: 31337, Size: 384x512, Seed: 26735311, Model: caulkinumV2_HOG, Steps: 15, Sampler: DPM++ 2M Karras, CFG scale: 6, Clip skip: 2, Model hash: 00ce56f9ac, Hires upscale: 2, Hires upscaler: 4x-AnimeSharp, Denoising strength: 0.6
>
> <img src="模型使用规范.assets/00026-26735311-caulkinumV2_HOG-[00ce56f9ac]-,_manguri_folded_holding_legs,_Shoulders_and_back_of_head_on_the_bed__legs_up_knees_on_chest_Butt_up,_spread_legs,_-_yellow_swea.jpeg" alt="00026-26735311-caulkinumV2_HOG-[00ce56f9ac]-,_manguri_folded_holding_legs,_Shoulders_and_back_of_head_on_the_bed__legs_up_knees_on_chest_Butt_up,_spread_legs,_-_yellow_swea.png" style="zoom:50%;" />
